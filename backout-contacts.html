...
<body id="page6">
            ...
            <div class="container_12">
                <div class="wrapper">
                	<article class="grid_4">
                        ...
                        <div class="img-indent-bot">
                            <figure class="img-border2">
								<iframe width="200" height="162" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=Creators+Engineers+%26+Interiors+Private+Limited,+Chennai,+Tamil+Nadu,+India&amp;aq=0&amp;oq=Creator&amp;sll=13.015108,80.23044&amp;sspn=0.001458,0.002642&amp;ie=UTF8&amp;hq=Creators+Engineers+%26+Interiors+Private+Limited,&amp;hnear=Chennai,+Tamil+Nadu,+India&amp;t=m&amp;ll=13.0263,80.21822&amp;spn=0.08903,0.069183&amp;output=embed"></iframe>
                            </figure>
                            <div class="clear"></div>
                        </div>
                        <dl>
                    ...
                    <article class="grid_8">
                    	<h3>Contact Form</h3>
                        <form id="contact-form" method="post" enctype="multipart/form-data" action="send_form_email.php">                    
                            <fieldset>
 ...
 alert("<?php echo htmlentities(urldecode($_GET["msg"])); ?>");
 </script>
 <?php endif; ?>
</body>
</html>
